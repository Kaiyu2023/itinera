...
on a map; route changes go through polls or leader approval while content edits stay
fast and fully historied; expenses are settled in a shared ledger; and your AI
assistant can join the planning through short-lived, scoped API tokens.
