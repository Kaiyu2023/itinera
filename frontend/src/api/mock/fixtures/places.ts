...
export const places: Place[] = [
  // --- Tokyo ---------------------------------------------------------------
  jp({ id: 'p-haneda', name: 'Haneda Airport (HND)', kind: 'transport_hub', lat: 35.5494, lng: 139.7798, city: 'Tokyo', adminArea: 'Tokyo', address: 'Ota City, Tokyo', photos: ['/photos/haneda-airport.webp'] }),
  ...
  jp({ id: 'p-shibuya', name: 'Shibuya Scramble Crossing', kind: 'sight', lat: 35.6595, lng: 139.7005, city: 'Tokyo', adminArea: 'Tokyo', address: 'Shibuya City, Tokyo', rating: 4.4, photos: ['/photos/shibuya-crossing.webp'] }),
  jp({ id: 'p-omoide', name: 'Omoide Yokocho', kind: 'food', lat: 35.6938, lng: 139.6993, city: 'Tokyo', adminArea: 'Tokyo', address: '1-2 Nishishinjuku, Shinjuku', rating: 4.3, priceLevel: 2, hours: ['Most stalls: 17:00–24:00'], photos: ['/photos/omoide-yokocho.webp'] }),
  jp({ id: 'p-sensoji', name: 'Sensō-ji', kind: 'sight', lat: 35.7148, lng: 139.7967, city: 'Tokyo', adminArea: 'Tokyo', address: '2-3-1 Asakusa, Taito', rating: 4.5, hours: ['Grounds always open; main hall 06:00–17:00'], photos: ['/photos/sensoji-kaminarimon.webp'] }),
  ...
  jp({ id: 'p-tsukiji', name: 'Tsukiji Outer Market', kind: 'food', lat: 35.6654, lng: 139.7707, city: 'Tokyo', adminArea: 'Tokyo', address: '4 Chome Tsukiji, Chuo', rating: 4.4, priceLevel: 2, hours: ['Shops ~05:00–14:00', 'Many shops closed Sun & Wed — go on a weekday morning'], photos: ['/photos/tsukiji-outer-market.webp'] }),
  jp({ id: 'p-meiji', name: 'Meiji Jingū', kind: 'sight', lat: 35.6764, lng: 139.6993, city: 'Tokyo', adminArea: 'Tokyo', address: '1-1 Yoyogikamizonocho, Shibuya', rating: 4.6, hours: ['Sunrise to sunset'], photos: ['/photos/meiji-jingu-torii.webp'] }),
  ...
  jp({ id: 'p-yumoto', name: 'Hakone-Yumoto Station', kind: 'transport_hub', lat: 35.2323, lng: 139.1069, city: 'Hakone', adminArea: 'Kanagawa', address: 'Yumoto, Hakone', hours: ['Coin lockers by the main exit'], photos: ['/photos/hakone-yumoto-station.webp'] }),
  ...
  jp({ id: 'p-nishiki', name: 'Nishiki Market', kind: 'food', lat: 35.0050, lng: 135.7649, city: 'Kyoto', adminArea: 'Kyoto', address: 'Nishikikoji-dori, Nakagyo', rating: 4.3, priceLevel: 2, hours: ['Most shops 10:00–17:00'], photos: ['/photos/nishiki-market.webp'] }),
  ...
  jp({ id: 'p-tokichi', name: 'Nakamura Tōkichi Honten (Uji)', kind: 'food', lat: 34.8894, lng: 135.8074, city: 'Uji', adminArea: 'Kyoto', address: '10 Ichiban, Uji', rating: 4.4, priceLevel: 2, hours: ['10:00–17:00'], photos: ['/photos/nakamura-tokichi.webp'] }),
  jp({ id: 'p-todaiji', name: 'Tōdai-ji (Nara)', kind: 'sight', lat: 34.6890, lng: 135.8398, city: 'Nara', adminArea: 'Nara', address: '406-1 Zoshicho, Nara', rating: 4.6, priceLevel: 1, hours: ['07:30–17:30'], photos: ['/photos/todaiji-daibutsuden.webp'] }),
  ...
  jp({ id: 'p-dotonbori', name: 'Dōtonbori', kind: 'sight', lat: 34.6687, lng: 135.5013, city: 'Osaka', adminArea: 'Osaka', address: 'Dotonbori, Chuo', rating: 4.4, hours: ['Best after dark'], photos: ['/photos/dotonbori.webp'] }),
  ...
  jp({ id: 'p-usj', name: 'Universal Studios Japan', kind: 'activity', lat: 34.6654, lng: 135.4323, city: 'Osaka', adminArea: 'Osaka', address: '2-1-33 Sakurajima, Konohana', rating: 4.4, priceLevel: 4, website: 'https://www.usj.co.jp', hours: ['Varies; ~09:00–21:00'], photos: ['/photos/usj-hollywood.webp'] }),
  jp({ id: 'p-kix', name: 'Kansai International Airport (KIX)', kind: 'transport_hub', lat: 34.4347, lng: 135.2440, city: 'Osaka', adminArea: 'Osaka', address: 'Izumisano, Osaka', photos: ['/photos/kansai-airport.webp'] }),
];
