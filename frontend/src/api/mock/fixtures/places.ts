...
export const places: Place[] = [
  // --- Tokyo ---------------------------------------------------------------
  jp({ id: 'p-haneda', name: 'Haneda Airport (HND)', kind: 'transport_hub', lat: 35.5494, lng: 139.7798, city: 'Tokyo', adminArea: 'Tokyo', address: 'Ota City, Tokyo' }),
  jp({ id: 'p-gracery', name: 'Hotel Gracery Shinjuku', kind: 'lodging', lat: 35.6952, lng: 139.7015, city: 'Tokyo', adminArea: 'Tokyo', address: '1-19-1 Kabukicho, Shinjuku', rating: 4.2, priceLevel: 3, website: 'https://shinjuku.gracery.com' }),
  jp({ id: 'p-shibuya', name: 'Shibuya Scramble Crossing', kind: 'sight', lat: 35.6595, lng: 139.7005, city: 'Tokyo', adminArea: 'Tokyo', address: 'Shibuya City, Tokyo', rating: 4.4 }),
  jp({ id: 'p-omoide', name: 'Omoide Yokocho', kind: 'food', lat: 35.6938, lng: 139.6993, city: 'Tokyo', adminArea: 'Tokyo', address: '1-2 Nishishinjuku, Shinjuku', rating: 4.3, priceLevel: 2, hours: ['Most stalls: 17:00–24:00'] }),
  jp({ id: 'p-sensoji', name: 'Sensō-ji', kind: 'sight', lat: 35.7148, lng: 139.7967, city: 'Tokyo', adminArea: 'Tokyo', address: '2-3-1 Asakusa, Taito', rating: 4.5, hours: ['Grounds always open; main hall 06:00–17:00'] }),
  jp({ id: 'p-teamlab', name: 'teamLab Planets', kind: 'activity', lat: 35.6494, lng: 139.7898, city: 'Tokyo', adminArea: 'Tokyo', address: '6-1-16 Toyosu, Koto', rating: 4.6, priceLevel: 3, website: 'https://www.teamlab.art/e/planets/', hours: ['09:00–22:00, timed entry'] }),
  jp({ id: 'p-tsukiji', name: 'Tsukiji Outer Market', kind: 'food', lat: 35.6654, lng: 139.7707, city: 'Tokyo', adminArea: 'Tokyo', address: '4 Chome Tsukiji, Chuo', rating: 4.4, priceLevel: 2, hours: ['Shops ~05:00–14:00', 'Many shops closed Sun & Wed — go on a weekday morning'] }),
  jp({ id: 'p-meiji', name: 'Meiji Jingū', kind: 'sight', lat: 35.6764, lng: 139.6993, city: 'Tokyo', adminArea: 'Tokyo', address: '1-1 Yoyogikamizonocho, Shibuya', rating: 4.6, hours: ['Sunrise to sunset'] }),
  ...
  jp({ id: 'p-ghibli', name: 'Ghibli Museum', kind: 'activity', lat: 35.6962, lng: 139.5704, city: 'Mitaka', adminArea: 'Tokyo', address: '1-1-83 Shimorenjaku, Mitaka', rating: 4.5, priceLevel: 2, website: 'https://www.ghibli-museum.jp', hours: ['10:00–18:00, closed Tue', 'Tickets: lottery/advance only, on sale 10th of prior month 10:00 JST'] }),
  ...
  // --- Kyoto -----------------------------------------------------------------
  jp({ id: 'p-kyotostation', name: 'Kyoto Station', kind: 'transport_hub', lat: 34.9858, lng: 135.7588, city: 'Kyoto', adminArea: 'Kyoto', address: 'Higashishiokoji, Shimogyo' }),
  ...
  jp({ id: 'p-todaiji', name: 'Tōdai-ji (Nara)', kind: 'sight', lat: 34.6890, lng: 135.8398, city: 'Nara', adminArea: 'Nara', address: '406-1 Zoshicho, Nara', rating: 4.6, priceLevel: 1, hours: ['07:30–17:30'] }),

  // --- Osaka -----------------------------------------------------------------
  jp({ id: 'p-osakacastle', name: 'Osaka Castle', kind: 'sight', lat: 34.6873, lng: 135.5262, city: 'Osaka', adminArea: 'Osaka', address: '1-1 Osakajo, Chuo', rating: 4.4, priceLevel: 1, hours: ['09:00–17:00, last entry 16:30'] }),
  ...
  jp({ id: 'p-dotonbori', name: 'Dōtonbori', kind: 'sight', lat: 34.6687, lng: 135.5013, city: 'Osaka', adminArea: 'Osaka', address: 'Dotonbori, Chuo', rating: 4.4, hours: ['Best after dark'] }),
  jp({ id: 'p-kuromon', name: 'Kuromon Ichiba Market', kind: 'food', lat: 34.6654, lng: 135.5060, city: 'Osaka', adminArea: 'Osaka', address: '2-4-1 Nipponbashi, Chuo', rating: 4.2, priceLevel: 2, hours: ['09:00–18:00'] }),
  jp({ id: 'p-usj', name: 'Universal Studios Japan', kind: 'activity', lat: 34.6654, lng: 135.4323, city: 'Osaka', adminArea: 'Osaka', address: '2-1-33 Sakurajima, Konohana', rating: 4.4, priceLevel: 4, website: 'https://www.usj.co.jp', hours: ['Varies; ~09:00–21:00'] }),
  jp({ id: 'p-kix', name: 'Kansai International Airport (KIX)', kind: 'transport_hub', lat: 34.4347, lng: 135.2440, city: 'Osaka', adminArea: 'Osaka', address: 'Izumisano, Osaka' }),
];
